$(document).ready(function () {
    ...
    $('#rsvp-form').on('submit', function (e) {
        ...
        $('#alert-wrapper').html(alert_markup('info', '<strong>Saving...</strong> We are saving your details.'))
        $('#alert-wrapper').html('');
...
// Google map
function initMap() {
    var itc_kol = {lat: 37.422247, lng: -122.084068};
...
function initBBSRMap() {
    var la_fiesta = {lat: 37.422247, lng: -122.084068};
    var map = new google.maps.Map(document.getElementById('map-canvas'), {
        zoom: 15,
        center: la_fiesta,
        scrollwheel: false
